...
// const arr=[1,2,3,4,"5"]
// const darr=arr.map((i)=>i*2)
// console.log(darr)

// Convert all strings to uppercase using map

// const strArr=["abc","lmn"]
// const upperArr=strArr.map((i)=>i.toUpperCase())
// console.log(upperArr)

// Filter numbers greater than a given value
// const arr=[1,2,3,4,5,6,"7","avvr"]
// const filterArr=arr.filter((i)=>i>4)
// console.log(filterArr)

// Filter even numbers from an array
// const num=[11,2,3,44,56,78,98,79]
// const evenNum=num.filter((i)=>i%2==0)
// console.log(evenNum)

// // Remove falsy values (false, 0, "", null, undefined, NaN) using filter
// const falsy=["",null,12,"abc",undefined]
// const remove=falsy.filter((i)=>Boolean(i))
// console.log(remove)

// Find product of numbers using reduce

// const arr=[1,2,3,4]
// const m=arr.reduce((mul,i)=>mul*i,1)
// console.log(m)

// Get square of even numbers
// const num=[1,2,3,4,5]
// const sqnum=num.filter((i)=>i%2==0).map((i)=>i**2)
// console.log(sqnum)

// Convert array of numbers to object {value: index}
// const arr=[1,2,3,4,5]
// const mapArr=arr.reduce((acc,i,index)=>{acc[index]=i
//     return acc
// },{})
// console.log(mapArr)
// Remove duplicates using filter or reduce
// const arr=[1,2,3,4,5,"5",6,3,2]
// const removeDuplicate=arr.reduce((acc,i,index)=>{
//     if(!acc.includes(i)){
//         acc.push(i)
//     }
//     return acc
...
// const extractEmail=users.map((i)=>i.email)
...
// const arr=cart.reduce((acc,i)=>acc+i.price,0)
// console.log(arr)
...
// const arr=cart.map((i)=>i.price*i.qty)
//  console.log(arr)
// const products = [
...
// const available=library.books.filter((i)=>i.available)
...
//   Given the following company object, filter out employees who work in the "HR" department.
    function filterEmp(obj,dept){
        return obj.departments.filter((i)=>i.name===dept)

    }
    console.log(filterEmp(company,"HR"))
